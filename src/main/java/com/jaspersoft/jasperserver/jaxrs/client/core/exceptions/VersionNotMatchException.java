 ...
 * @version $Id$
 */
public class VersionNotMatchException extends JSClientWebException {

    public static final String ERROR_VERSION_NOT_MATCH = "version.not.match";
    ...
    public VersionNotMatchException(String message, List<ErrorDescriptor> errorDescriptors) {
