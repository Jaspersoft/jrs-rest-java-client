...
public class ReportStartPageGreaterThenEndPageException extends JSClientWebException {
    ...
    public ReportStartPageGreaterThenEndPageException(String message) {
        super(message);
    }

    public ReportStartPageGreaterThenEndPageException(String message, List<ErrorDescriptor> errorDescriptors) {
