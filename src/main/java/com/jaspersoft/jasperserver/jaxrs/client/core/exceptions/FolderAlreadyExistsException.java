...
public class FolderAlreadyExistsException extends ResourceAlreadyExistsException {
    ...
    public static final String FOLDER_ALREADY_EXISTS = "folder.already.exits";
    ...
    public FolderAlreadyExistsException(String message, List<ErrorDescriptor> errorDescriptors) {
