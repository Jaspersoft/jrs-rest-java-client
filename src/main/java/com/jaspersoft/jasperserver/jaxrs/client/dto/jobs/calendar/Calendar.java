...
public abstract class Calendar {
    ...
    protected ClientJobCalendar.Type calendarType;
    ...
    public ClientJobCalendar.Type getCalendarType() {
        return calendarType;
    }

    public Calendar setCalendarType(ClientJobCalendar.Type calendarType) {
