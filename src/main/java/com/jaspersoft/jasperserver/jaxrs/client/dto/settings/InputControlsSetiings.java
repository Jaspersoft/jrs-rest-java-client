...
/**
 * Created by tetiana.iefimenko on 7/21/2015.
 */
public class InputControlsSetiings {

    private Boolean useUrlParametersOnReset;

    public InputControlsSetiings() {
    }

    public InputControlsSetiings(InputControlsSetiings other) {
    ...
    public InputControlsSetiings setUseUrlParametersOnReset(Boolean useUrlParametersOnReset) {
