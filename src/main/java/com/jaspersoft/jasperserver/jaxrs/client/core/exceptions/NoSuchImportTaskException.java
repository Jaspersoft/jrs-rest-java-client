 ...
 */
public class NoSuchImportTaskException extends JSClientWebException {
    ...
    public NoSuchImportTaskException(String message) {
        super(message);    //To change body of overridden methods use File | Settings | File Templates.
    }

    public NoSuchImportTaskException(String message, List<ErrorDescriptor> errorDescriptors) {
