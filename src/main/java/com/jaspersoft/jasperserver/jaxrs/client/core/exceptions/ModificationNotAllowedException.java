...
public class ModificationNotAllowedException extends AccessDeniedException {
    ...
    public static final String ERROR_CODE_MODIFICATION_NOT_ALLOWED = "modification.not.allowed";
    ...
    public ModificationNotAllowedException(String message, List<ErrorDescriptor> errorDescriptors) {
