...
//        initMocks(this);
//        PowerMockito.doNothing().when(SessionStorage.class, "init");
//        sessionStorageSpy = PowerMockito.spy(new SessionStorage(expectedClientConfiguration, expectedCredentials));
//    }
//
