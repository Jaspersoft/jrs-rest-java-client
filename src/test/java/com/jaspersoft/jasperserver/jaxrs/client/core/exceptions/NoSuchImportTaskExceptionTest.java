...
/**
 * Unit tests for {@link com.jaspersoft.jasperserver.jaxrs.client.core.exceptions.NoSuchImportTaskException}
 */
public class NoSuchImportTaskExceptionTest {

    @Test
    public void should_invoke_parent_constructor() {
        NoSuchImportTaskException exception = new NoSuchImportTaskException();
        assertNotNull(exception.getErrorDescriptors());
    }

    @Test
    public void should_pass_message_to_parent_class() {
        NoSuchImportTaskException exception = new NoSuchImportTaskException("msg");
    ...
    public void should_pass_message_and_descriptors_to_parent_class() {
        ...
        NoSuchImportTaskException exception = new NoSuchImportTaskException("msg", expected);
