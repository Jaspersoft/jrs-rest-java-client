...
/**
 * Unit tests for {@link com.jaspersoft.jasperserver.jaxrs.client.core.exceptions.AccessDeniedException}
 */
public class AccessDeniedExceptionTest {
    ...
    public void should_pass_message_to_parent_class() {
        AccessDeniedException exception = new AccessDeniedException("msg");
    ...
    public void should_pass_message_and_descriptors_to_parent_class() {
        ...
        AccessDeniedException exception = new AccessDeniedException("msg", expected);
