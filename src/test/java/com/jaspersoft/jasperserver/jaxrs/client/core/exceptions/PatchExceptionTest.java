...
/**
 * Unit tests for {@link com.jaspersoft.jasperserver.jaxrs.client.core.exceptions.PatchException}
 */
public class PatchExceptionTest {
    ...
    public void should_pass_message_to_parent_class() {
        PatchException exception = new PatchException("msg");
    ...
    public void should_pass_message_and_descriptors_to_parent_class() {
        ...
        PatchException exception = new PatchException("msg", expected);
